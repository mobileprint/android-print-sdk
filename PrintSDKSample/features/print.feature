...
@kitkat
@TA12260
Scenario Outline: Print a card in Kitkat device and verify xml counters for 'PDF' option
    Given I am on Home screen
    Then I tap on "PDF" option
    And I select layout as "<Layout Type>"
    And I select preview button 
...
@kitkat
@TA12260
Scenario Outline: Print a card in Kitkat device and verify xml counters for 'Image' option
    Given I am on Home screen
    Then I tap on "Image" option
    And I select layout as "<Layout Type>"
    And I select preview button 
