...
public class PrintPluginInstaller {
    ...
    private final String SHOW_PLUGIN_INSTALL_MESSAGE_KEY = "com.hp.mss.hpprint.ShowPluginInstallMessage";
    private final String SHOW_PLUGIN_ENABLE_MESSAGE_KEY = "com.hp.mss.hpprint.ShowPluginEnableMessage";
